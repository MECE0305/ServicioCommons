...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "EstadoEvaluacion.findAll", query = "SELECT e FROM EstadoEvaluacion e"),
...
public class EstadoEvaluacion implements Serializable {
	...
	public String toString() {
		return "javaapplication1.EstadoEvaluacion[ idEstado=" + idEstado + " ]";
	}
