...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EmpleadoHasRol.findAll", query = "SELECT c FROM ChecklistHasEvaluacion c")
...
public class EmpleadoHasRol implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.empleadoHasRolPK == null && other.empleadoHasRolPK != null) || (this.empleadoHasRolPK != null && !this.empleadoHasRolPK.equals(other.empleadoHasRolPK))) {
            return false;
        }
        return true;
    }
