...
public class EvaluacionHasEncabezado implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.evaluacionHasEncabezadoPK == null && other.evaluacionHasEncabezadoPK != null) || (this.evaluacionHasEncabezadoPK != null && !this.evaluacionHasEncabezadoPK.equals(other.evaluacionHasEncabezadoPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "javaapplication1.EvaluacionHasEncabezado[ evaluacionHasEncabezadoPK=" + evaluacionHasEncabezadoPK + " ]";
    }
